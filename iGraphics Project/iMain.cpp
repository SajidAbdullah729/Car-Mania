/*
	...
	Last updated: 22 SEP 2020 (FINAL UPDATE)
*/
#include "iGraphics.h"
#include <stdio.h>
#include <fstream>
...
//car-car collision, car-coin collision, car-extra life collision
void collision()
{
...
{	
	...
	iSetTimer(12, trafficMove);
	iSetTimer(15, coinMove);
	iSetTimer(15, gameBackground);
	iSetTimer(14, extraLife);
